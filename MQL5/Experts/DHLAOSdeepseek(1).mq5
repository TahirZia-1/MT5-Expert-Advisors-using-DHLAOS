...
bool BuySignal() {
    ...
    Print("BuySignal check: AOS conditions met = ", c, " | Time: ", TimeCurrent());
    if (!c) return false;
    ...
    Print("BUY SIGNAL TRIGGERED at ", TimeCurrent(), " | Price: ", Ask());
    return true;
}
...
bool SellSignal() {
    ...
    Print("SellSignal check: AOS conditions met = ", c, " | Time: ", TimeCurrent());
    if (!c) return false;
    ...
    Print("SELL SIGNAL TRIGGERED at ", TimeCurrent(), " | Price: ", Bid());
    return true;
}
